...
exports.MAINTENANCE_INTENTS = exports.SAFE_INTENTS = exports.ALL_INTENTS = exports.INTENT_CATALOG = exports.REQUIRED_ENTITIES = exports.FUNCTION_NAMES = void 0;
exports.validateIntentCatalog = validateIntentCatalog;
...
var defineIntents = function (t) { return t; };
/**
 * Canonical intent catalog.
 * Your chatbot should ONLY recommend calls that appear here.
 */
exports.INTENT_CATALOG = defineIntents({
    DASHBOARD_OVERVIEW: {
        description: "Fetch the full dashboard payload (summary KPIs + per-locomotive map).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    NON_COMPLIANT_COUNT: {
        description: "Count of non-compliant locomotives (function returns a count).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    DAILY_INSPECTIONS_COMPLETED_KPI: {
        description: "Count of locomotives with daily inspections completed (dashboard summary).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    DAILY_INSPECTIONS_DUE_KPI: {
        description: "Count of locomotives due for daily inspection (dashboard summary).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    INSPECTIONS_COMPLETED_TODAY_COUNT: {
        description: "Count of inspections completed today (service timezone day bounds).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    DAILY_DUE_TODAY_COUNT: {
        description: "Count of locomotives due today for daily inspection (service day bounds).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_OUT_OF_SERVICE_LOCOS: {
        description: "List locomotives where assetStates.outOfUse is true (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_AVAILABLE_LOCOS: {
        description: "List locomotives where assetStates.outOfUse is false (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_NON_COMPLIANT_LOCOS: {
        description: "List locomotives where assetStates.nonCompliant is true (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_DAILY_DUE_LOCOS_TODAY: {
        description: "List locomotives due today for daily inspection (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
        ...
        followUpQuestion: "Do you mean due *today* (within the service's day bounds) or a custom date range?",
        safety: "safe",
    ...
    LIST_LOCOS_MISSING_LAST_INSPECTION: {
        description: "List locomotives with missing/empty LastInspec (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_LOCOS_MISSING_DUE_INSPECTION: {
        description: "List locomotives with missing/empty DueInspec (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_LOCOS_WITH_OOU_CREDIT_AVAILABLE: {
        description: "List locomotives with outOfUseCredit.status indicating available credit (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    LIST_LOCOS_WITH_ENGINE_HOURS_OVER_THRESHOLD: {
        description: "List locomotives with engine hours over a threshold (client-side filter).",
        requiresLoco: false,
    ...
    LIST_ALL_LOCOS_FROM_ASSET_SERVICE: {
        description: "List locomotives from the underlying assets source (raw assets list).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    FIND_LOCO_BY_LOCO_NUMBER: {
        description: "Find locomotive(s) by loco number (client-side search over dashboard assetData).",
        requiresLoco: true,
    ...
    FIND_LOCO_BY_NAME: {
        description: "Find locomotive(s) by name (client-side search over dashboard assetData).",
        requiresLoco: true,
    ...
    LOCO_OUT_OF_USE_CREDIT_SUMMARY: {
        ...
        followUpQuestion: "Which locomotive assetId (or loco number so I can look it up)?",
        safety: "safe",
        triggerPhrases: [
            "out of use credit",
            "oou credit",
    ...
    LOCO_OUT_OF_USE_CREDIT_FROM_DASHBOARD: {
        description: "Read out-of-use credit values from dashboard-stored assetData.",
        requiresLoco: true,
        requiredEntities: ["assetId"],
        recommendedCalls: [
            {
    ...
    LOCO_NEXT_DUE_INSPECTION: {
        description: "Get the next due inspection for a locomotive (service helper).",
        requiresLoco: true,
        requiredEntities: ["assetId"],
        recommendedCalls: [
            {
    ...
    LOCO_LAST_INSPECTION_SUMMARY: {
        description: "Read last inspection summary from dashboard-stored assetData.",
        requiresLoco: true,
        requiredEntities: ["assetId"],
        recommendedCalls: [
            {
    ...
    LOCO_LAST_INSPECTION_TEST_CODE_ONLY: {
        description: "Read last inspection test code from dashboard-stored assetData.",
        requiresLoco: true,
        requiredEntities: ["assetId"],
        recommendedCalls: [
            {
    ...
    LOCO_LAST_INSPECTION_INSPECTOR_NAME: {
        description: "Read last inspection inspector name from dashboard-stored assetData.",
        requiresLoco: true,
        requiredEntities: ["assetId"],
        recommendedCalls: [
            {
    ...
    LOCO_LAST_INSPECTION_INSPECTOR_EMAIL: {
        description: "Read last inspection inspector email from dashboard-stored assetData (PII).",
        requiresLoco: true,
        requiredEntities: ["assetId"],
        recommendedCalls: [
            {
    ...
    FLEET_LAST_INSPECTED_WITHIN_RANGE: {
        description: "List locos last-inspected within a date range (client-side filter).",
        requiresLoco: false,
    ...
    FLEET_DUE_IN_NEXT_7_DAYS: {
        description: "List locos with inspections due in next 7 days (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    FLEET_DUE_IN_NEXT_30_DAYS: {
        description: "List locos with inspections due in next 30 days (client-side filter).",
        requiresLoco: false,
        requiredEntities: [],
        recommendedCalls: [
            {
    ...
    FLEET_OVERDUE_INSPECTIONS: {
        ...
        followUpQuestion: "Should I exclude locomotives with no due date (missing nextExpiryDate), or list them as 'unknown'?",
        safety: "safe",
    ...
    FLEET_DUE_BY_TEST_CODE: {
        description: "List locos with due inspection for a test code (client-side filter).",
        requiresLoco: false,
        requiredEntities: ["testCode"],
        recommendedCalls: [
            {
    ...
    VALIDATE_TEST_CODE_EXISTS: {
        description: "Check if a given test code exists (client-side membership check).",
        requiresLoco: false,
        requiredEntities: ["testCode"],
        recommendedCalls: [
            {
    ...
    MAINT_REFRESH_REBUILD_DASHBOARD: {
        ...
        readTheseFields: ["$"],
        followUpQuestion: "This action has side effects. If you really want it, confirm with CONFIRM_WRITE.",
    ...
    MAINT_UPDATE_LOCO_STATE_IN_DASHBOARD: {
        ...
        readTheseFields: ["$"],
        followUpQuestion: "This action has side effects. Provide locoId and confirm with CONFIRM_WRITE.",
        safety: "maintenance_only",
        notes: "Blocked by default in advisor mode (write/side-effect).",
        triggerPhrases: [
            "update loco state",
    ...
    MAINT_RECALC_OOU_CREDIT_AND_SAVE: {
        description: "Recalculate and update out-of-use credit for a locomotive (write).",
        requiresLoco: true,
        requiredEntities: ["locoId", "confirmWrite"],
        recommendedCalls: [
            {
    ...
    MAINT_UPDATE_LAST_AND_DUE_INSPECTION_FIELDS: {
        description: "Update stored last/due inspection fields in dashboard (write).",
        requiresLoco: true,
        requiredEntities: [
            "date",
            "unitId",
        ...
        readTheseFields: ["$"],
        followUpQuestion: "This action has side effects. Provide date, unitId, test title, test code, user info, and confirm with CONFIRM_WRITE.",
        safety: "maintenance_only",
        notes: "Blocked by default in advisor mode (write/side-effect).",
        triggerPhrases: [
    ...
    INTERNAL_RESOLVE_MU_HEAD_HELPER: {
        description: "Internal helper to resolve MU id/head from a locomotive list (not recommended to end users).",
        requiresLoco: true,
        ...
        readTheseFields: ["$"],
        followUpQuestion: "This is an internal helper. Provide locoId and a locos array (usually value.assetData values).",
        safety: "maintenance_only",
...
exports.ALL_INTENTS = Object.keys(exports.INTENT_CATALOG);
/** Convenience lists */
exports.SAFE_INTENTS = exports.ALL_INTENTS.filter(function (id) { return exports.INTENT_CATALOG[id].safety === "safe"; });
exports.MAINTENANCE_INTENTS = exports.ALL_INTENTS.filter(function (id) { return exports.INTENT_CATALOG[id].safety === "maintenance_only"; });
/**
...
function validateIntentCatalog() {
    var fnSet = new Set(exports.FUNCTION_NAMES);
    for (var _i = 0, _a = Object.entries(exports.INTENT_CATALOG); _i < _a.length; _i++) {
        var _b = _a[_i], id = _b[0], spec = _b[1];
        for (var _c = 0, _d = spec.recommendedCalls; _c < _d.length; _c++) {
            var call = _d[_c];
            if (!fnSet.has(call.function)) {
                throw new Error("Intent ".concat(id, " references unknown function: ").concat(call.function));
            }
        }
    }
}
