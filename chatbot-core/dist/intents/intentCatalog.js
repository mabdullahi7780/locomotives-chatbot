...
/** Convenience lists */
exports.SAFE_INTENTS = exports.ALL_INTENTS.filter((id) => exports.INTENT_CATALOG[id].safety === "safe");
exports.MAINTENANCE_INTENTS = exports.ALL_INTENTS.filter((id) => exports.INTENT_CATALOG[id].safety === "maintenance_only");
/**
...
function validateIntentCatalog() {
    const fnSet = new Set(exports.FUNCTION_NAMES);
    for (const [id, spec] of Object.entries(exports.INTENT_CATALOG)) {
        for (const call of spec.recommendedCalls) {
            if (!fnSet.has(call.function)) {
                throw new Error(`Intent ${id} references unknown function: ${call.function}`);
            }
        }
    }
}
