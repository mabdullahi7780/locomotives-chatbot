...
const functionCatalog = __importStar(require("./../../docs/FUNCTION_CATALOG.json"));
// Try to import dashboard snapshot - adjust path based on your actual file location
// If the file is at chatbot-core level:
// import * as dashboardSnapshot from "./../dashBoardDataJSON.json";
// If it's at the project root:
